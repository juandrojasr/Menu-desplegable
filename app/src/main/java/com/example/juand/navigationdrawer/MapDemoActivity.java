...
public class MapDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.btnAyuda);
    ...
    public void onClickAyuda(View v) {
        String url = "https://wa.me/+573007551846?text=Hola!%20,tengo%20una%20denuncia%20estoy%20en%20'location'"+"%20-Enviado%20desde%20APP%20Mujer%20Segura";
    ...
    protected void loadMap(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLng(new LatLng(4.6482837, -74.2478943)));
